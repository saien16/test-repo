...
- **あみの えらびかた**: きほんのあみ(2m・近いほど命中UP・こわれやすい)は常備。
  フィールドで **1m/3m/おおあみ/じょうぶな2m/👑きんのあみ** を拾うと、距離別の命中と
  破損率がちがう。「遠くから安全に(3m)」か「近づいて高命中(1m・高警戒・壊れやすい)」か、
  どの網で振るかで戦略が変わる。網が壊れると きほんのあみは その捕獲中だけ「てづかみ」に。
